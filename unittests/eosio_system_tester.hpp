...
public:
   ...
   eosio_system_tester(Lambda setup) {
      ...
      BOOST_REQUIRE_EQUAL( core_from_string("1000000000.0000"), get_balance( "led" ) );
      ...
      BOOST_REQUIRE_EQUAL( core_from_string("1000000000.0000"), get_balance("led")  + get_balance("led.ramfee") + get_balance("led.stake") + get_balance("led.ram") );
   }
   ...
   asset get_balance( const account_name& act ) {
      vector<char> data = get_row_by_account( N(led.token), act, N(accounts), symbol(CORE_SYMBOL).to_symbol_code().value );
   ...
   abi_serializer initialize_multisig() {
      abi_serializer msig_abi_ser;
      {
         ...
         BOOST_REQUIRE_EQUAL( success(), buyram( "led", "led.msig", core_from_string("5000.0000") ) );
         produce_block();
   ...
   vector<name> active_and_vote_producers() {
      ...
      transfer( "led", "alice1111111", core_from_string("650000000.0000"), "led" );
