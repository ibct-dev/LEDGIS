...
`--add-code` [code] add 'led.code' permission to specified permission authority

`--remove-code` [code] remove 'led.code' permission from specified permission authority
