...
static constexpr eosio::name kv_ram = "led.kvram"_n;
static constexpr eosio::name kv_disk = "led.kvdisk"_n;
...
template <typename T, eosio::name::raw SingletonName, eosio::name::raw DbName = "led.kvram"_n>
class kv_singleton {
   kv_environment environment;
