...
const static name system_account_name    { "led"_n };
const static name null_account_name      { "led.null"_n };
const static name producers_account_name { "led.prods"_n };
...
const static name led_auth_scope       { "led.auth"_n };
const static name led_all_scope        { "led.all"_n };

const static name active_name     { "active"_n };
const static name owner_name      { "owner"_n };
const static name led_any_name  { "led.any"_n };
const static name eosio_code_name { "led.code"_n };
