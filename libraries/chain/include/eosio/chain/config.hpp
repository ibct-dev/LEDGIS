...
const static name system_account_name    { N(led) };
const static name null_account_name      { N(led.null) };
const static name producers_account_name { N(led.prods) };
...
const static name led_auth_scope       { N(led.auth) };
const static name led_all_scope        { N(led.all) };

const static name active_name     { N(active) };
const static name owner_name      { N(owner) };
const static name led_any_name  { N(led.any) };
const static name eosio_code_name { N(led.code) };
