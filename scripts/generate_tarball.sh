...
#sed "s/_PREFIX_/\/${SPREFIX}/g" ${BUILD_DIR}/modules/LEDTesterPackage.cmake &> ${EOS_PREFIX}/lib/cmake/${PROJECT}/LEDTester.cmake
...
#ln -sf ../../../${SUBPREFIX}/lib/cmake/${PROJECT}/LEDTester.cmake LEDTester.cmake
#popd &> /dev/null
