...
- DRYRUN=true is required for all tests and automatically enabled. You can use this when you're manually running legis_build.sh (`DRYRUN=true VERBOSE=true ./scripts/legis_build.sh`)
